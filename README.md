...
이번 하계 워크샵이 중간에 종료 됨에 따라 **태그팀**에서는 매주 5문제 백준 알고리즘을 푸는 것으로 대신 했었습니다. 그때 느낀점은 _나랑은 푸는 방법이 달라도 팀장님이나 멘토 분들의 코드를 보고 싶다_ 였습니다. 따라서 **Caerang-tutor**를 생각하게 되었습니다. 또한 기존 **Copilot**은 깃허브의 public 레포지토리들을 학습하였다고 하지만 저작권 문제와 추후 높은 비용 문제가 발생 할 수 있다는 점이 있습니다. 그래서 생각한 것이 _씨애랑 동아리만을 위한 Copilot을 만들면 좋겠다고 생각하게 되었습니다._

### 설명
* **NodeJS**를 통해 서버를 구축하여 ~~웹 또는 앱(아직 미정)으로 통신하는 방법을 고민 중~~
<U>백엔드 구축에 시간이 필요할 것으로 판단되어 앱을 기본으로 제작, 이후 웹을 제작 할 예정<U/>
